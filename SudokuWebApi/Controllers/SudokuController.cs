...
namespace SudokuWebApi.Controllers
{
    ...
    {
        private readonly List<WebApiSudoku> sudokuList = new List<WebApiSudoku>();
        public SudokuController()
        {
            ...
            this.sudokuList.Add(new WebApiSudoku() { Id = 3, Name = "expert", SpaghettiString =   "980030006050049300000000000000400001700208000106000040078002000000000209409005000" });
        }

        [HttpGet("{id}")]
        public String Get(int id)
        {
            return sudokuList[id].SpaghettiString;
        }
    }
}
